...
export function DataTable<TData, TValue>({ columns, data, filterColumn, filterPlaceholder = 'Filter...'}: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="overflow-hidden rounded-md border border-slate-200 dark:border-slate-700/60">
        <Table>
          <TableHeader>
